...
import { 
  BarChart3, ShieldCheck, TrendingUp, FileText, Gavel, 
  Users, Target, ArrowRight, CheckCircle2, Bot, 
  Sparkles, History, ClipboardCheck, Layout, 
  ShieldAlert, Activity, Globe, Scale, MessageSquare,
  // Added XCircle to fix "Cannot find name 'XCircle'" error on lines 86 and 221
  TrendingDown, Search, Cpu, Zap, XCircle
} from 'lucide-react';
...
export const CISOsSecurityLeadership: React.FC<{ onNavigate?: (page: string) => void }> = ({ onNavigate }) => {
  return (
    <div className="bg-white min-h-screen text-slate-900 font-sans selection:bg-hayrok-orange/20 selection:text-hayrok-orange pb-12 overflow-x-hidden relative">
      ...
      <section className="relative pt-48 pb-32 overflow-hidden border-b border-slate-100 bg-[#FBFBF9]">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            Roles: CISOs & Security Executives
          </motion.div>
          ...
          >
            Strategic <br />
            <span className="text-hayrok-orange italic tracking-tighter">Confidence.</span>
          </motion.h1>
          ...
          >
            Move from reporting technical activity to demonstrating business integrity. Hayrok empowers CISOs to translate fragmented security signals into board-ready decisions.
          </motion.p>
      ...
      {/* Scenario Deep Dive: The Communication Gap */}
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <motion.div {...fadeInUp}>
              ...
              <h3 className="text-4xl md:text-7xl font-black text-slate-900 mb-8 leading-[1.05] tracking-tight uppercase">
                The Boardroom <br/> <span className="text-slate-400 italic">Complexity Gap.</span>
              </h3>
              <p className="text-xl text-slate-600 font-medium leading-relaxed mb-10">
                Security executives need to explain complex postures to stakeholders who care about business outcomes. Lists of "Critical" vulnerabilities lack the context required to prove real-world risk reduction or compliance due diligence.
              </p>
              
              <div className="space-y-6">
                 {[
                   { t: "Technical Noise vs. Strategic Signal", d: "Executives are buried in scanner data that doesn't articulate the actual impact on revenue or trust." },
                   { t: "Auditor & Regulator Scrutiny", d: "Regulators no longer accept 'we scanned it' as proof of security. They demand an auditable lineage of risk decisions." },
                   { t: "The ROI Justification", d: "Difficulty proving that security spend is actually making the organization safer quarter-over-quarter." }
                 ].map((p, i) => (
            ...
            <div className="relative">
               <div className="bg-slate-900 rounded-[4rem] p-12 shadow-2xl relative overflow-hidden text-white flex flex-col justify-center border border-white/5 h-[550px]">
                  ...
                  <div className="relative z-10">
                     <p className="text-[10px] font-black text-hayrok-orange uppercase tracking-[0.6em] mb-12">The CISO's Mandate</p>
                     <p className="text-3xl md:text-5xl font-black italic text-white mb-10 leading-tight">
                        “The board doesn't want <span className="text-hayrok-orange">Charts</span>; <br/> they want <span className="text-slate-400 underline decoration-hayrok-orange underline-offset-8">Defensible Decisions.</span>”
                     </p>
                     <p className="text-slate-500 font-bold uppercase tracking-widest text-[11px]">The evolution from security operator to business risk owner.</p>
                  </div>
               </div>
            </div>
          </div>
      ...
      <section className="py-32 bg-white">
        <div className="container mx-auto px-6">
           <div className="text-center max-w-4xl mx-auto mb-24">
              ...
              <p className="text-xl text-slate-500 font-medium mt-10">Hayrok provides the intelligence and governance layer to translate technical truth into strategic outcomes.</p>
           </div>
           ...
           <div className="grid lg:grid-cols-3 gap-8">
              {[
                { 
                  ...
                  d: "Converts thousands of technical findings into a handful of governed decisions. Hive establishes an auditable system of record for why risks were fixed or accepted.",
                  icon: Gavel,
                  points: ["Policy-bound decisions", "Auditable rationale", "Risk acceptance trails"]
                },
                { 
                  n: "02", t: "Visualize", 
                  h: "Executive Narratives", 
                  d: "Generates executive-ready summaries and posture trends. Move away from spreadsheets and move toward automated dashboards aligned to CTEM maturity.",
                  icon: Layout,
                  points: ["Board-ready summaries", "Cross-domain risk trends", "Gartner-aligned metrics"]
                },
                { 
                  n: "03", t: "Demonstrate", 
                  h: "Risk Reduction ROI", 
                  d: "Demonstrates measurable risk reduction over time. Answer the question 'Are we safer now?' with technical evidence from Genesis validation runs.",
                  icon: TrendingDown,
                  points: ["Validated risk movement", "Proof of fix effectiveness", "Investment performance"]
                }
              ].map((step, i) => (
                 <motion.div 
                    key={i}
      ...
      {/* Strategic Outcome: The Unified View */}
            ...
            <div className="grid lg:grid-cols-2 gap-24 items-center">
               <div className="relative">
                  <div className="aspect-square max-w-lg mx-auto bg-white/5 border border-white/10 rounded-[4rem] p-12 flex flex-col items-center justify-center text-center shadow-3xl">
                     ...
                     <h4 className="text-3xl font-black uppercase tracking-tight mb-6">Integrity <br/> <span className="text-hayrok-orange italic">is the standard.</span></h4>
                     <p className="text-slate-400 font-medium leading-relaxed">
                        When security decisions are backed by proof, the CISO can move from a defensive posture to a strategic one, aligned with the board's growth objectives.
                     </p>
                  </div>
                  {/* Decorative Elements */}
                  <motion.div 
               ...
               <div>
                  <h2 className="text-[10px] font-black text-hayrok-orange uppercase tracking-[0.5em] mb-10">Board Alignment</h2>
                  <h3 className="text-4xl md:text-6xl font-black mb-10 leading-tight uppercase tracking-tight">The Modern <br/> <span className="text-hayrok-orange">Security Leader.</span></h3>
                  <div className="space-y-10">
                     {[
                        { t: "Executive Clarity", d: "Present a unified view of risk that the CEO and Board can understand instantly." },
                        { t: "Audit-Ready Rationale", d: "Satisfy regulators with a complete decision lineage for every high-stakes risk choice." },
                        { t: "Investment Confidence", d: "Prove that your security budget is tied directly to the removal of validated attack paths." }
                     ].map((item, i) => (
         ...
         <div className="container mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-12 gap-8">
               <div className="lg:col-span-8 bg-slate-50 border border-slate-200 rounded-[4rem] p-12 md:p-16 flex flex-col justify-center">
                  <h4 className="text-3xl font-black text-slate-900 mb-10 uppercase">Velocity <span className="text-hayrok-orange">Engineered.</span></h4>
               ...
               <div className="lg:col-span-4 bg-slate-900 rounded-[4rem] p-12 text-white relative overflow-hidden shadow-2xl flex flex-col justify-center text-center">
                  ...
                  <h4 className="text-2xl font-black mb-4 uppercase tracking-tight">Are we safer?</h4>
                  <p className="text-slate-400 text-sm font-medium leading-relaxed">
                     Yes. And we have the validation artifacts to prove it. Move beyond assumptions and report on truth.
                  </p>
         ...
         <div className="container mx-auto px-6 relative z-10">
            <motion.div {...fadeInUp} className="max-w-5xl mx-auto">
               ...
               <p className="text-xl md:text-3xl text-slate-500 font-medium mb-16 leading-relaxed max-w-3xl mx-auto">
                  Bring clarity, credibility, and validation to your security program. Experience the future of Governed Risk Intelligence.
               </p>
               <div className="flex flex-col md:flex-row justify-center items-stretch gap-6">
                 <button onClick={() => onNavigate?.('demo')} className="bg-hayrok-orange text-white px-16 py-8 rounded-[2rem] text-2xl font-black hover:bg-orange-600 transition-all transform hover:scale-105 shadow-2xl shadow-orange-500/20">
                    Schedule Strategic Walkthrough
                 </button>
      ...
      <div className="h-32 flex items-center justify-center border-t border-slate-100 bg-white">
         <p className="text-[11px] font-bold text-slate-300 uppercase tracking-[0.8em] text-center px-6 leading-relaxed max-w-5xl">
            CISO and Security Leadership solutions powered by Hayrok Hive, Genesis, and CodeFabrics. Governed, continuous, and built for measurable risk reduction.
         </p>
      </div>
    </div>
  );
