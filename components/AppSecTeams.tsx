...
import { 
  ShieldCheck, Users, Zap, Code, Search, Target, 
  ...
  Cpu, TrendingUp, MessageSquare, HeartHandshake,
  UserPlus, Terminal, ListChecks, Layout
} from 'lucide-react';
...
export const AppSecTeams: React.FC<{ onNavigate?: (page: string) => void }> = ({ onNavigate }) => {
  return (
    <div className="bg-white min-h-screen text-slate-900 font-sans selection:bg-hayrok-orange/20 selection:text-hayrok-orange pb-12 overflow-x-hidden relative">
      ...
      <section className="relative pt-48 pb-32 overflow-hidden border-b border-slate-100 bg-[#FBFBF9]">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            Roles: Application Security Teams
          </motion.div>
          ...
          >
            Credibility <br />
            <span className="text-hayrok-orange italic tracking-tighter">Through Validation.</span>
          </motion.h1>
          ...
          >
            Stop delivering "maybe" risks. Hayrok empowers AppSec teams to filter scanner noise and provide developers with verified, exploitable proof.
          </motion.p>
          ...
          <motion.div {...fadeInUp} className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <button onClick={() => onNavigate?.('contact')} className="w-full sm:w-auto px-12 py-6 rounded-2xl font-black text-xl text-slate-900 border border-slate-200 hover:bg-white transition-all bg-white shadow-sm flex items-center gap-3">
              <MessageSquare size={20} className="text-hayrok-orange" />
              Speak with a Security Engineer
            </button>
          </motion.div>
        </div>
      </section>

      {/* Scenario Deep Dive: The Trust Deficit */}
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <motion.div {...fadeInUp}>
              ...
              <h3 className="text-4xl md:text-7xl font-black text-slate-900 mb-8 leading-[1.05] tracking-tight uppercase">
                The Developer <br/> <span className="text-slate-400 italic">Trust Deficit.</span>
              </h3>
              <p className="text-xl text-slate-600 font-medium leading-relaxed mb-10">
                AppSec teams need to reduce vulnerability noise while improving credibility with engineering and leadership. Every time a "Critical" alert turns out to be unexploitable noise, AppSec's influence shrinks.
              </p>
              
              <div className="space-y-6">
                 {[
                   { t: "The Noise Penalty", d: "SCA and SAST scanners find thousands of theoretical bugs that developer teams eventually learn to ignore." },
                   { t: "Manual Triage Bottleneck", d: "Security engineers spend 80% of their time verifying if a finding is 'real' instead of architecting solutions." },
                   { t: "The 'Blocker' Label", d: "Rigid security gates that stop builds for non-reachable vulnerabilities create operational friction and developer animosity." }
                 ].map((p, i) => (
            ...
            <div className="relative">
               <div className="bg-slate-900 rounded-[4rem] p-12 shadow-2xl relative overflow-hidden text-white flex flex-col justify-center border border-white/5 h-[550px]">
                  ...
                  <div className="relative z-10">
                     <p className="text-[10px] font-black text-hayrok-orange uppercase tracking-[0.6em] mb-12">The AppSec Reality</p>
                     <p className="text-3xl md:text-5xl font-black italic text-white mb-10 leading-tight">
                        “We aren't fighting <span className="text-hayrok-orange">Vulnerabilities</span>; <br/> we are fighting <span className="text-slate-400 underline decoration-hayrok-orange underline-offset-8">Information Overload.</span>”
                     </p>
                     <p className="text-slate-500 font-bold uppercase tracking-widest text-[11px]">The fundamental failure of activity-based security.</p>
                  </div>
               </div>
            </div>
          </div>
      ...
      <section className="py-32 bg-white">
        <div className="container mx-auto px-6">
           <div className="text-center max-w-4xl mx-auto mb-24">
              ...
              <h3 className="text-4xl md:text-7xl font-black text-slate-900 tracking-tight leading-none uppercase">From Gatekeeper <br/><span className="text-hayrok-orange italic">To Enabler.</span></h3>
              <p className="text-xl text-slate-500 font-medium mt-10">Hayrok acts as a high-fidelity intelligence layer that sits between your scanners and your engineers.</p>
           </div>
           ...
           <div className="grid lg:grid-cols-3 gap-8">
              {[
                { 
                  n: "01", t: "Validate", 
                  h: "Filtered Signal", 
                  d: "Filters exposure signals through autonomous validation. Genesis engine runs non-destructive probes to confirm exploitability.",
                  icon: Zap,
                  points: ["Eliminates theoretical noise", "Confirms reachability", "Reduces manual triage time"]
                },
                { 
                  n: "02", t: "Prioritize", 
                  h: "Material Risk Focus", 
                  d: "Shows which findings actually matter to the business. Focus fixes on paths that lead to sensitive data or high-trust identities.",
                  icon: Target,
                  points: ["Impact-based scoring", "Identity mesh context", "Cloud posture correlation"]
                },
                { 
                  n: "03", t: "Communicate", 
                  h: "Narrative Proof", 
                  d: "Provides clear narratives engineers can trust. Move beyond JSON logs to human-readable proof artifacts and exploit walkthroughs.",
                  icon: Sparkles,
                  points: ["Auditable rationale", "Step-by-step proof", "Remediation guidance"]
                }
              ].map((step, i) => (
                 <motion.div 
                    key={i}
      ...
      {/* Strategic Outcome: Partner Status */}
            ...
            <div className="grid lg:grid-cols-2 gap-24 items-center">
               <div className="relative">
                  <div className="aspect-square max-w-lg mx-auto bg-white/5 border border-white/10 rounded-[4rem] p-12 flex flex-col items-center justify-center text-center shadow-3xl">
                     ...
                     <h4 className="text-3xl font-black uppercase tracking-tight mb-6">Partnership <br/> <span className="text-hayrok-orange italic">is the new gate.</span></h4>
                     <p className="text-slate-400 font-medium leading-relaxed">
                        When security findings come with technical proof, the conversation changes from "Is this real?" to "How do we fix this together?"
                     </p>
                  </div>
                  {/* Decorative Elements */}
                  <motion.div 
               ...
               <div>
                  ...
                  <h3 className="text-4xl md:text-6xl font-black mb-10 leading-tight uppercase tracking-tight">The Modern <br/> <span className="text-hayrok-orange">AppSec Partner.</span></h3>
                  <div className="space-y-10">
                     {[
                        { t: "Engineering Credibility", d: "Deliver zero-false-positive findings to development teams, restoring trust in security guidance." },
                        { t: "Lifecycle Awareness", d: "Move from point-in-time scanning to continuous validation aligned with CTEM maturity." },
                        { t: "Executive Clarity", d: "Report risk reduction in terms of validated material impact rather than vulnerability counts." }
                     ].map((item, i) => (
      ...
      <section className="py-32 bg-white">
         <div className="container mx-auto px-6">
            <div className="text-center max-w-4xl mx-auto mb-24">
               ...
               <h3 className="text-4xl md:text-7xl font-black text-slate-900 tracking-tight leading-none uppercase">Measurable <br/><span className="text-hayrok-orange italic">Outcomes.</span></h3>
            </div>
            ...
            <div className="grid lg:grid-cols-12 gap-8">
               <div className="lg:col-span-8 bg-slate-50 border border-slate-200 rounded-[4rem] p-12 md:p-16 flex flex-col justify-center">
                  <h4 className="text-3xl font-black text-slate-900 mb-10 uppercase">Efficiency <span className="text-hayrok-orange">Engineered.</span></h4>
                  <div className="grid md:grid-cols-2 gap-10">
                     <div className="space-y-4">
                        ...
                        <p className="text-slate-500 font-medium">Automated validation cuts manual triage time by up to 60%, allowing engineers to focus on higher-value risk modeling.</p>
                     </div>
                     <div className="space-y-4">
                        ...
                        <p className="text-4xl font-black text-slate-900 tracking-tighter">Faster Velocity.</p>
                        <p className="text-slate-500 font-medium">Smarter build gates that only block for validated, reachable risks—preventing unnecessary deployment delays.</p>
                     </div>
                  </div>
               </div>
               ...
               <div className="lg:col-span-4 bg-slate-900 rounded-[4rem] p-12 text-white relative overflow-hidden shadow-2xl flex flex-col justify-center text-center">
                  ...
                  <p className="text-slate-400 text-sm font-medium leading-relaxed">
                     Ignore the noise. Focus only on the 5% of findings that are proven exploitable in your specific application mesh.
                  </p>
         ...
         <div className="container mx-auto px-6 relative z-10">
            <motion.div {...fadeInUp} className="max-w-5xl mx-auto">
               <h3 className="text-5xl md:text-[10rem] font-black text-slate-900 mb-12 tracking-tight leading-[0.8] uppercase">
                 Own The <br/> <span className="text-hayrok-orange italic tracking-tighter">Result.</span>
               </h3>
               <p className="text-xl md:text-3xl text-slate-500 font-medium mb-16 leading-relaxed max-w-3xl mx-auto">
                  Bring clarity, credibility, and validation to your AppSec program. Become the strategic partner your organization needs.
               </p>
      ...
      <div className="h-32 flex items-center justify-center border-t border-slate-100 bg-white">
         <p className="text-[11px] font-bold text-slate-300 uppercase tracking-[0.8em] text-center px-6 leading-relaxed max-w-5xl">
            Application Security Team solutions powered by Hayrok Hive, Genesis, and CodeFabrics. Governed, continuous, and built for measurable velocity.
         </p>
      </div>
    </div>
  );
