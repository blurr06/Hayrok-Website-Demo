...
export const SaaSCloudNativeCompanies: React.FC<{ onNavigate?: (page: string) => void }> = ({ onNavigate }) => {
  return (
    <div className="bg-white min-h-screen text-slate-900 font-sans selection:bg-hayrok-orange/20 selection:text-hayrok-orange pb-12 overflow-x-hidden relative">
      ...
      <section className="relative pt-48 pb-32 overflow-hidden border-b border-slate-100 bg-[#FBFBF9]">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            Industry Track: SaaS & Cloud-Native
          </motion.div>
          ...
          >
            Velocity with <br />
            <span className="text-hayrok-orange italic tracking-tighter">Validated Trust.</span>
          </motion.h1>
          ...
          >
            Secure modern infrastructure at the speed of code. Hayrok integrates intelligent, validation-driven gates into your CI/CD pipelines to ensure only material risks slow down your releases.
          </motion.p>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <motion.div {...fadeInUp}>
              ...
              <h3 className="text-4xl md:text-7xl font-black text-slate-900 mb-8 leading-[1.05] tracking-tight uppercase">
                The SaaS <br/> <span className="text-slate-400 italic">Velocity Trap.</span>
              </h3>
              <p className="text-xl text-slate-600 font-medium leading-relaxed mb-10">
                In cloud-native environments, deployment speed is the lifeblood of the business. However, traditional security tools often act as a blunt instrument—blocking releases based on raw, unvalidated findings.
              </p>
              
              <div className="space-y-6">
                 {[
                   { t: "Rapid Deployment Friction", d: "Most 'critical' warnings that delay releases are actually unexploitable within the context of the environment." },
                   { t: "Overwhelming Tool Noise", d: "SCA, SAST, and CSPM scanners generate thousands of alerts that lack reachability context." },
                   { t: "Noisy CI/CD Gates", d: "Static build-breakers kill developer momentum and lead to 'gate fatigue' and bypass culture." },
                   { t: "The Proof Problem", d: "Difficulty proving that security remediation actually reduces risk in an ephemeral environment." }
                 ].map((p, i) => (
               ...
               <div className="bg-slate-900 rounded-[4rem] p-12 shadow-2xl relative overflow-hidden text-white flex flex-col justify-center border border-white/5 h-[550px]">
                  ...
                  <div className="relative z-10">
                     ...
                     <p className="text-3xl md:text-5xl font-black italic text-white mb-10 leading-tight">
                        “We ship code <span className="text-hayrok-orange">100x a day</span>, <br/> but security checks <br/> still feel like <span className="text-slate-400 underline decoration-hayrok-orange underline-offset-8">annual events.</span>”
                     </p>
                     <p className="text-slate-500 font-bold uppercase tracking-widest text-[11px]">The fundamental failure of legacy security logic in the cloud.</p>
                  </div>
               </div>
            </div>
          </div>
      ...
      {/* How Hayrok Helps: The 4 Pillars of Cloud-Native Security */}
        ...
        <div className="container mx-auto px-6">
           ...
           <div className="grid lg:grid-cols-4 gap-6">
              {[
                { 
                  n: "01", t: "Ingest", 
                  h: "Multi-Signal Ingestion", 
                  d: "CodeFabrics ingests signals from SAST, SCA, IaC, container, and cloud tools. We normalize findings from Snyk, GitHub, and Trivy into a unified view.",
                  icon: Database,
                  points: ["Normalized Finding Data", "Transitive Trust Mapping", "BYOS Integration"]
                },
                { 
                  n: "02", t: "Gate", 
                  h: "Validation-Driven Gates", 
                  d: "Gates deployments based on validated attack paths, not raw findings. We only block what is proven to represent material risk in your VPC.",
                  icon: GitMerge,
                  points: ["Reachability-aware gates", "Reduced false blocks", "Developer-friendly feedback"]
                },
                { 
                  n: "03", t: "Validate", 
                  h: "Continuous Pentesting", 
                  d: "Supports modern penetration testing as a continuous practice. Genesis engine runs safe probes to confirm exploitability in real-time.",
                  icon: Zap,
                  points: ["Adversary truth loops", "Non-destructive probing", "Identity path verification"]
                },
                { 
                  n: "04", t: "Confirm", 
                  h: "Remediation Proof", 
                  d: "Confirms remediation effectiveness through autonomous re-validation. We prove the risk is gone before we update the scorecard.",
                  icon: RefreshCw,
                  points: ["Fix effectiveness verification", "Audit-ready artifact trail", "Decision lineage tracking"]
                }
              ].map((step, i) => (
                 <motion.div 
                    key={i}
         ...
         <div className="container mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-24 items-center">
               <div className="relative">
                  <div className="aspect-square max-w-lg mx-auto bg-white/5 border border-white/10 rounded-[4rem] p-12 flex flex-col items-center justify-center text-center shadow-3xl">
                     ...
                     <p className="text-slate-400 font-medium leading-relaxed">
                        In SaaS, security shouldn't be an "ask for permission" model. Hayrok builds security into the "definition of done" with technical proof that engineers trust.
                     </p>
                  </div>
                  {/* Decorative Elements */}
                  <motion.div 
               ...
               <div>
                  ...
                  <h3 className="text-4xl md:text-6xl font-black mb-10 leading-tight uppercase tracking-tight">Confidence <br/> <span className="text-hayrok-orange">at the Speed of Code.</span></h3>
                  <div className="space-y-10">
                     {[
                        { t: "Faster Releases", d: "Reduce developer frustration by eliminating non-material blockers in the CI/CD pipeline." },
                        { t: "Reduced Vuln Noise", d: "Validation-driven filtering reduces the triage backlog by up to 90%, focusing effort on material risk." },
                        { t: "Measurable Risk Reduction", d: "Deliver board-ready evidence that security work is actually shrinking the exploitable attack surface." }
                     ].map((item, i) => (
      ...
      <section className="py-32 bg-white">
         <div className="container mx-auto px-6">
            <div className="text-center max-w-4xl mx-auto mb-24">
               ...
               <h3 className="text-4xl md:text-7xl font-black text-slate-900 tracking-tight leading-none uppercase">Velocity <br/><span className="text-hayrok-orange italic">Engineered.</span></h3>
            </div>
            ...
            <div className="grid lg:grid-cols-12 gap-8">
               <div className="lg:col-span-8 bg-slate-50 border border-slate-200 rounded-[4rem] p-12 md:p-16 flex flex-col justify-center">
                  <h4 className="text-3xl font-black text-slate-900 mb-10 uppercase">Frictionless <span className="text-hayrok-orange">Maturity.</span></h4>
         ...
         <div className="container mx-auto px-6 relative z-10">
            <motion.div {...fadeInUp} className="max-w-5xl mx-auto">
               ...
               <p className="text-xl md:text-3xl text-slate-500 font-medium mb-16 leading-relaxed max-w-3xl mx-auto">
                  Bring clarity, credibility, and validation to your SaaS security program. Become the platform partner your organization needs.
               </p>
      ...
      <div className="h-32 flex items-center justify-center border-t border-slate-100 bg-white">
         <p className="text-[11px] font-bold text-slate-300 uppercase tracking-[0.8em] text-center px-6 leading-relaxed max-w-5xl">
            SaaS and Cloud-Native solutions powered by Hayrok Hive, Genesis, and CodeFabrics. Governed, continuous, and built for measurable delivery speed.
         </p>
      </div>
    </div>
  );
